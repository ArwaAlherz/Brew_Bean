...
<header>
  ...
  <nav>
   ...
   <?php if(!isset($_SESSION['customer_id'])) { ?>
    ...
    <a href="login.php" data-en="Login" data-ar="تسجيل الدخول">Login</a>

<?php } else { ?>

    <a href="logout.php" data-en="Logout" data-ar="تسجيل الخروج">Logout</a>
...
<div class="hero">
  ...
  <div class="hero-content">
    <h2 data-en="Premium Coffee,<br>Delivered to You" data-ar="قهوة مميزة،<br>تصل إليك">Premium Coffee,<br>Delivered to You</h2>
  ...
  <div class="dp-body">
    ...
    <div class="dp-content">
      ...
      <div class="dp-recipe" id="dpRecipe" style="display:none">
        ...
        <img src="images/وصفة مقترحه.png" alt="Brewing Recipe" onerror="this.parentElement.style.display='none'">
      </div>
    </div>
  </div>
</div>
